...
fetch('https://www.yiketianqi.com/free/day?appid=85746969&appsecret=pAyZu2xh&unescape=1')
    .then(response => response.json())
    .then(data => {
        if(!data) return;
...
$("#github").mouseover(function () {
    ...
    $("#link-text").html("If you call me superman");
});
$("#qq").mouseover(function () {
    $("#link-text").html("有事要联系吗？");
}).mouseout(function () {
    $("#link-text").html("If you call me superman");
});
$("#email").mouseover(function () {
    $("#link-text").html("给我发 Email");
}).mouseout(function () {
    $("#link-text").html("If you call me superman");
});
$("#telegram").mouseover(function () {
    $("#link-text").html("添加我的电报？");
}).mouseout(function () {
    $("#link-text").html("If you call me superman");
});
$("#blogger").mouseover(function () {
    $("#link-text").html("去 博客 看看");
}).mouseout(function () {
    $("#link-text").html("If you call me superman");
});
...
$('#switchmore').on('click', function () {
    ...
    if (showmore && $(document).width() >= 990) {
        ...
        $("#change").html("Oops&nbsp;!");
        $("#change1").html("哎呀，这都被你发现了（ 再次点击可关闭 ）");
    } else {
